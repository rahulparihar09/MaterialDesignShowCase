...
public class TransitionFirstActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		slideExitTransition.excludeTarget(android.R.id.navigationBarBackground,
				true);
		slideExitTransition.excludeTarget(android.R.id.statusBarBackground,
				true);
		slideExitTransition
				.excludeTarget(R.id.activity_transition_header, true);
	...
	public void onFabPressed(View view) {
		...
		ActivityOptions transitionActivityOptions = ActivityOptions
				.makeSceneTransitionAnimation(TransitionFirstActivity.this,
