...
import git.rahulparihar.materialdesignshowcase.utils.GUIUtils;
import git.rahulparihar.materialdesignshowcase.utils.UploadHelper;
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabButton.setImageDrawable(getResources().getDrawable(R.drawable.ic_drawer));
